 ...
 * @LastEditors: xyw
 * @LastEditTime: 2022-05-12 19:38:52
 * @Description: 
-->
...
let option = {
  legend: {
    ...
    // right:0,
    // width:500,
    top: fontChart(30), // 上距离
    bottom: fontChart(20), // 下距离
    itemGap: fontChart(20), // 间隔
    itemWidth: fontChart(8), // 图形宽度。
    itemHeight: fontChart(8), // 图形高度。
    formatter(name) {
