 ...
 * @LastEditTime: 2022-05-15 11:32:49
  ...
  <div class="box">
    <div class="head sc-flex sc-ai-center sc-jc-center">
      <div class="tag sc-mr-6">
        ...
        <div class="bottom sc-flex sc-ai-center sc-jc-center blue">{{list.runStatusCount[0].count}}<span class="sc-fs-xl">个</span></div>
      </div>
      <div class="tag">
        <div class="top orange">离线设备</div>
        <div class="bottom sc-flex sc-ai-center sc-jc-center orange">{{list.runStatusCount[1].count}}<span class="sc-fs-xl">个</span></div>
      </div>
    </div>
  ...
  .head {
    ...
    .tag {
      ...
      .bottom {
        ...
        border-radius: 1px;
        &.blue { 
          background:rgba(1,200,214,.15) ;
          border: 2px solid #0b6bb6;
          color:#01c8d6;
        }
        &.orange { 
          background:rgba(231,201,19,.15)  ;
